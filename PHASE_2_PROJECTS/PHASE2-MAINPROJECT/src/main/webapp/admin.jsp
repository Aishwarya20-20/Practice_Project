...
<table style="width:50%; margin: 0px auto;">
	<tr>
		<td><label for="Email" style="font-size:16pt;" >Email</label></td>
    <td><input type="email" name="oldPass" style="font-size:16pt; width:270px;" /></td>
	</tr>
...
<br> <br>
 <table style="width:20%">
  <tr>
  <td> <input value= "submit" value="reset" style="font-size:20pt; width:82pt; background#DEB4B4"/> </td>
  </tr>
</table>
